...
func ExamplePrint() {
	...
	// Output like:
	// PRINT AT goutils/dump.ExamplePrint(LINE 14):
	// int(23)
	// []string{"ab", "cd"}
	// []int [
	//   1,
...
func TestConfig(t *testing.T) {
	...
	is.Contains(buf.String(), "goutils/dump/dump_test.go:")
	buf.Reset()
}
...
func TestPrint(t *testing.T) {
	...
	// print position
	Fprint(buf, 123)
	// "PRINT AT goutils/dump.TestPrint(dump_test.go:65)"
	str := buf.String()
	is.Contains(str, "PRINT AT goutils/dump.TestPrint(dump_test.go:")
...
func TestStruct_CannotExportField(t *testing.T) {
	...
	// OUT:
	// PRINT AT goutils/dump.TestStruct_CannotExportField(dump_test.go:202)
