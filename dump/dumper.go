...
func (d *Dumper) printCaller(pc uintptr, file string, line int) {
	...
	// eg:
	// "PRINT AT goutils/dump.ExamplePrint(goutil/dump/dump_test.go:23)"
	// "PRINT AT goutils/dump.ExamplePrint(dump_test.go:23)"
	// "PRINT AT goutils/dump.ExamplePrint(:23)"
